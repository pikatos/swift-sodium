...
extension GenericHash {
    public class Stream {
        ...
        private var opaqueState: OpaquePointer//UnsafeMutablePointer<crypto_generichash_state>
        ...
        init?(key: Bytes?, outputLength: Int) {
            ...
            guard let baseAddress = state.baseAddress else { return nil }
            opaqueState = OpaquePointer(baseAddress)
